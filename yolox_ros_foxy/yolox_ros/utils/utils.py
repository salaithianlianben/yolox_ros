...
class yolox_py(Node):
    ...
    def parameter_ros2(self):
        # パラメータ設定 ###################################################
        self.declare_parameter('model_path', 'yolox_ros/weights/yolox_nano.onnx')
        ...
        self.declare_parameter('input_shape/height', 640)
        self.declare_parameter('input_shape/width', 640)
